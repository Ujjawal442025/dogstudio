...
const Dog = () => {
  ...
  const [normalMap] = useTexture([base + "/dog_normals.jpg"]).map((texture) => {
    texture.flipY = false;
  ...
  const [branchMap, branchNormalMap] = useTexture([
    base + "/branches_diffuse.dds",
    base + "branches_normals.dds",
  ]).map((texture) => {
    texture.colorSpace = THREE.SRGBColorSpace;
    return texture;
  });
  ...
  useEffect(() => {
    ...
    document
      .querySelector(`.title[img-title="navypier"]`)
      .addEventListener("mouseenter", () => {
    ...
    document
      .querySelector(`.title[img-title="msichicago"]`)
      .addEventListener("mouseenter", () => {
    ...
    document
      .querySelector(`.title[img-title="thiswas"]`)
      .addEventListener("mouseenter", () => {
